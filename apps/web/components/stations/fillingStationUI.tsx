...
export default function FillingStationUI({ station, isGasAvailable, priceValue, priceUnit }: { station: any, isGasAvailable: boolean, priceValue: string, priceUnit: string }) {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <section className="relative group">
              ...
              {station.verified && (
                <div className="absolute top-6 right-6 chip-verified shadow-lg bg-white px-3 py-1.5 rounded-full flex items-center gap-1.5 text-sm font-bold text-[#006b28]">
            ...
            <section className="space-y-4">
              ...
              <div className="flex items-center gap-4 bg-white px-5 py-3 rounded-xl shadow-ambient border border-gray-100/50 w-fit mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-6 rounded-xl shadow-ambient flex flex-col gap-4">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold uppercase tracking-widest text-[#505d6f] opacity-40 font-label">Cooking Gas</span>
                    <div className="w-10 h-10 rounded-full bg-[#006b28]/10 flex items-center justify-center">
                      <Flame className="w-5 h-5 text-[#006b28]" />
                    </div>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-[#191c1d]">LPG</p>
                    <div className="flex items-center gap-2 mt-2">
                      <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse"></div>
                      <span className="text-sm font-bold text-emerald-700">In Stock</span>
                    </div>
                  </div>
                  <p className="text-3xl font-extrabold text-[#191c1d] mt-2">{priceValue}<span className="text-sm font-medium text-gray-400">{priceUnit}</span></p>
                </div>
                ...
                <div className="bg-[#f3f4f5] p-6 rounded-xl flex flex-col gap-4 opacity-60">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold uppercase tracking-widest text-gray-400 font-label tracking-widest">Diesel</span>
